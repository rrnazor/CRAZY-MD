...
var session = conf.session.replace(/CRAZY-MD-WHATSAPP-BOT;;;=>/g,"");
...
setTimeout(() => {
    async function main() {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            const dj = '237694268225';
            const dj2 = '237694268225';
            const dj3 = "237694268225";
            const luffy = '237620114013';
            ...
            var verifZokAdmin = verifGroupe ? admins.includes(idBot) : false;
             ...
             if(superUser || verifAdmin || !verifZokAdmin  ) { console.log('je fais rien'); return};
                                   ...
                                   // txt += `message supprimé \n @${auteurMessage.split("@")[0]} rétiré du groupe.`;
                                    const gifLink = "https://raw.githubusercontent.com/CrazyPrince/CRAZY-MD/main/media/remover.gif";
...
╔═════◇
 ...
 thanks you for choosing CRAZY MD
